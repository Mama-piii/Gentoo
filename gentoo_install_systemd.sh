...
# Verify (optional if you trust the source)
...
# Hostname
hostnamectl set-hostname acer-gentoo
...
# Root password (you should change it)
...
echo "✅ Gentoo base installation finished. Reboot when ready."
